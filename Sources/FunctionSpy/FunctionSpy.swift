...
public func spy<each A, Result>(
    ...
    return (spy, { @Sendable (a: repeat each A) -> Result in
        spy.increment()
...
public func spy<each A, Result>(
    ...
    return (spy, { @Sendable (a: repeat each A) throws -> Result in
        spy.increment()
        spy.recordCall(repeat each a)
...
public func spy<each A, Result>(
    ...
    return (spy, { @Sendable (a: repeat each A) async -> Result in
        spy.increment()
        spy.recordCall(repeat each a)
...
public func spy<each A, Result>(
    ...
    return (spy, { @Sendable (a: repeat each A) async throws -> Result in
        spy.increment()
        spy.recordCall(repeat each a)
